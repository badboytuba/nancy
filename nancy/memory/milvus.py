...
from nancy.memory.base import MemoryProviderSingleton, get_ada_embedding
...
class MilvusMemory(MemoryProviderSingleton):
    ...
    def __init__(self, cfg) -> None:
        ...
        self.schema = CollectionSchema(fields, "NAncymemory storage")
